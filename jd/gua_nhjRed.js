...
https://u.jd.com/kKUnhdc
跳转到app 可查看助力情况

返利变量：gua_nhjRed_rebateCode，若需要返利给自己，请自己修改环境变量[gua_nhjRed_rebateCode]
kKUnhdc换成自己的返利
export gua_nhjRed_rebateCode="kKUnhdc"

需要助力[火力值]的账号pin值
如：【京东账号2】pin
pin1换成对应的pin值 用,分开
只助力2个 满了脚本自动从ck1开始替换未满的
export gua_nhjRed_rebatePin="tyokantei,gieghie"


*/

let rebateCodes = 'kKUnhdc'
let rebatePin = ''
...
let shareCodeArr = {}
$.runArr = {}
const activeEndTime = '2022/11/11 00:00:00+08:00';//活动结束时间

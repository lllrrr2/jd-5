...
$.inviteList = [];
$.pkInviteList = [
  'sSKNX-MpqKMFVwFhCiUMhBXIBnvBU50-w9gpV193BuWyBuaWUeTIEw',
];
$.secretpInfo = {};
$.innerPkInviteList = [
];
...
!(async () => {
  ...
  let res = [], res2 = [], res3 = [];
  res3 = await getAuthorShareCode('https://gitee.com/zzw_wei/sharecode1/raw/master/jd_cityShareCodesm.json');
  if (!res3) await getAuthorShareCode('https://gitee.com/zzw_wei/sharecode1/raw/master/jd_cityShareCodesm.json')
  if (new Date().getHours()>= 17) {
    res = await getAuthorShareCode() || [];
    res2 = await getAuthorShareCode('https://gitee.com/zzw_wei/sharecode1/raw/master/jd_cityShareCodesm.json') || [];
  }
  if (pKHelpAuthorFlag) {
...
function getAuthorShareCode(url = "https://gitee.com/zzw_wei/sharecode1/raw/master/jd_cityShareCodesm.json") {
  return new Promise(async resolve => {
    const options = {
      "url": `${url}?${new Date()}`,
      "timeout": 10000,
